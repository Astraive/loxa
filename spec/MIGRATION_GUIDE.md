...
The LOZA specification has been restructured to use canonical sources under `spec/` with deterministic contract generation. Legacy mirror folders (`schema/`, `openapi/`, `proto/`) will continue to work for backward compatibility but are no longer the sources of truth.
...
```
spec/
│   ├── schemas/json/          # ← Canonical LOZA JSON schemas
│   ├── openapi/               # ← Canonical LOZA OpenAPI specs
...
proto/
  loza/
    v1/
      event.proto              # ← Canonical proto source (was spec/proto/loza/core)
      ingest.proto
      collector.proto
      cortex.proto
...
gen/
  go/
    loza/
      v1/*.pb.go              # ← Generated Go code (was spec/proto/loza/core/*.pb.go)
...
from generated.contract import loza_contract
...
protoc --proto_path=spec/cortex/proto \
  spec/cortex/proto/loza/core/cortex.proto
```
...
contract_path = Path("generated/contract/loza-contract.json")
...
# config.json
{
    ...
    "contract_path": "generated/contract/loza-contract.json",
...
```
proto/loza/core/*.proto      # Canonical source of truth
```

Generated Go code is at:
```
gen/go/loza/core/*.pb.go     # Generated by protoc
```
...
**A:** Load `generated/contract/loza-contract.json` or `generated/contract/cortex-contract.json` at startup. These are deterministic artifacts generated from `spec/`.
...
grep -r "spec/schemas/\|spec/openapi/\|proto/loza" src/  # Should see new proto paths

# Verify proto sources are in the new location
ls proto/loza/core/*.proto

# Generate Go code from proto
go run ./cmd/loza proto  # or: make proto
```
