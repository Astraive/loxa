...
// TestBuildEventGeneratesTraceContext verifies that buildEvent generates trace context when not provided.
// Requirements: 39.6
...
// TestBuildEventGeneratesTraceIDWhenOnlySpanIDProvided verifies that trace_id is generated even when span_id is provided.
// Requirements: 39.6
...
// TestBuildEventGeneratesSpanIDWhenOnlyTraceIDProvided verifies that span_id is generated even when trace_id is provided.
// Requirements: 39.6
