...
class Middleware:
    """ASGI middleware that captures request lifecycle as one LOZA wide event."""
    ...
    def wrap_scope(self, scope: dict[str, Any]) -> object:
...
def _header(scope: dict[str, Any], wanted: bytes) -> str:
...
def _remote_ip(scope: dict[str, Any]) -> str:
