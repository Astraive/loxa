...
import (
	...
	"github.com/astraive/loza/cli/internal/cli"
...
func printUsage() {
	fmt.Printf("LOZA CLI v%s\n", version.Version)
	fmt.Println("\nCommands:")
	fmt.Println("  init         Initialize LOZA config")
	...
	fmt.Println("Use 'loza <command> --help' for details")
}
