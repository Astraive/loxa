...
| **Phase 2** | v0.0.1 releases | Mirror folders remain for backward compat, but undocumented |
| **Phase 3** | v0.0.1 | Mirror folders removed |
| **Phase 4** | v0.0.1 | Legacy path support removed from SDKs |
