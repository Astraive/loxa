...
proto/
  loxa/
    v1/
      event.proto              # ← Canonical proto source (was spec/proto/loxa/core)
      ingest.proto
      collector.proto
      cortex.proto
...
gen/
  go/
    loxa/
      v1/*.pb.go              # ← Generated Go code (was spec/proto/loxa/core/*.pb.go)
...
protoc --proto_path=spec/cortex/proto \
  spec/cortex/proto/loxa/core/cortex.proto
```
...
```
proto/loxa/core/*.proto      # Canonical source of truth
```

Generated Go code is at:
```
gen/go/loxa/core/*.pb.go     # Generated by protoc
```
