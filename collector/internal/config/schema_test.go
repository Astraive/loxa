...
func TestServerConfigDefaults(t *testing.T) {
	...
	assert.Equal(t, ":9308", cfg.Collector.Server.HTTP.Addr)
	...
	assert.Equal(t, ":9309", cfg.Collector.Server.GRPC.Port)
	...
	assert.Equal(t, ":9310", cfg.Collector.Server.GraphQL.Port)
