...
require (
	...
	github.com/astraive/loza/sdks/go/src/middleware v0.0.0
)

require (
	github.com/astraive/loza/spec v0.3.4 // indirect
...
replace github.com/astraive/loza/sdks/go/src/middleware => ../../src/middleware
